...
ENCODER_MODEL = model_utils.Encoder(lstm_units=units,embed_dim=embed_dim,vocab=vocab_enc,batch_size=BATCH_SIZE)
DECODER_MODEL = model_utils.Decoder(lstm_units=units,embed_dim=embed_dim,vocab=vocab_dec,batch_size=BATCH_SIZE)
